...
namespace AluraFlix.Infrastructure.Migrations
{
    ...
    [Migration("20221105204350_AdicionadoATabelaCategoriaEColunaCategoriaIdVideo")]
    partial class AdicionadoATabelaCategoriaEColunaCategoriaIdVideo
    {
            ...
            modelBuilder.Entity("AluraFlix.Domain.Entities.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cor = "#FFFFFF",
                            DataCriacao = new DateTimeOffset(new DateTime(2022, 11, 5, 17, 43, 49, 493, DateTimeKind.Unspecified).AddTicks(490), new TimeSpan(0, -3, 0, 0, 0)),
                            Titulo = "LIVRE"
                        });
                });
