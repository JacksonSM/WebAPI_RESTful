...
namespace AluraFlix.Infrastructure.Migrations
{
    ...
    [Migration("20221116224540_AdicaoDaTabelaUsuario")]
    partial class AdicaoDaTabelaUsuario
    {
            ...
            modelBuilder.Entity("AluraFlix.Domain.Entities.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cor = "#FFFFFF",
                            DataCriacao = new DateTimeOffset(new DateTime(2022, 11, 16, 19, 45, 40, 472, DateTimeKind.Unspecified).AddTicks(4478), new TimeSpan(0, -3, 0, 0, 0)),
                            Titulo = "LIVRE"
                        });
                });
